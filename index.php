...
// $post[] = array('s_full_name'=>'');
if(isset($_POST['search-term'])){  
  $post= searchT($_POST['track']); 

if(!empty($post)){
 if($post[0]['status']==1){

  $post[0]['status'] = "<h3 style='color:Blue;'>Picked Up for delivery</h3>";
 } 
 elseif($post[0]['status']==2){
 $post[0]['status'] = '<h3 style="color:red;">In transit</h3>';

 }
 elseif($post[0]['status']==3){
   $post[0]['status'] = '<h3 style="color:green;">Delivered</h3>';
 }
}
}
                                ; ?>
                                ...
                                <div class="main-menu d-none d-lg-block">
                                    <nav> 
                                        <ul id="navigation">                                                                                          
                                            ...
                                            <li><a href="admin/posts/index.php">Dashboard</a>
                                            <?php endif; ?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-9 col-lg-9">
                            ...
                            <!--Hero form -->
                            <form action="index.php" class="search-box" method="post">
                                <div class="input-form">
                                    <input type="text" name='track' placeholder="Your Tracking ID">
                                </div>
                                <div >
                                  <button  type="submit"  name="search-term" class="btn">Track & Trace </button> 
                                </div>	
                            ...
                            <div class="card border-success mb-3" style="max-width: 25rem;">
                              <div class="card-header" style=""><h4>Status<?php  echo $post[0]['status']
                                ; ?></h4></div>
                                <div style="display:flex;flex-direction:row;">
                              <div class="card-body text-success">
                              <h6>Sender and Receiver's Information</h6>
                              <hr style="margin-top:0px;">
                                <h6 class="card-title">Sender's Name <br> <?php  echo $post[0]['s_full_name']
                                ; ?>
                                <h6 class="card-title">Sender's Email <br> <?php  echo $post[0]['s_email']
                                ; ?>
                                <h6 class="card-title">Sender's Address <br> <?php  echo $post[0]['s_address']
                                ; ?>
                                <h6 class="card-title">Receiver's Name <br> <?php  echo $post[0]['r_full_name']
                                ; ?>
                                <h6 class="card-title">Receiver's Email <br> <?php  echo $post[0]['r_email']
                                ; ?>
                                <h6 class="card-title">Receiver's Address <br> <?php  echo $post[0]['r_address']
                                ; ?>
                              ...
                              <hr style="margin-top:0px;">
                                <h6 class="card-title">Parcel type <br> <?php  echo $post[0]['freight_type']
                                ; ?>
                                <h6 class="card-title">Weight<br> <?php  echo $post[0]['weight']
                                ; ?>
                                <h6 class="card-title">Payment <br> <?php  echo $post[0]['payment']
                                ; ?>
                                <h6 class="card-title">Origin <br> <?php  echo $post[0]['origin']
                                ; ?>
                                <h6 class="card-title">Destination <br> <?php  echo $post[0]['destination']
                                ; ?>
                                <h6 class="card-title">Shipment Mode<br> <?php  echo $post[0]['shipment_mode']
                                ; ?>
                                <h6 class="card-title">Parcel Content <br> <?php  echo $post[0]['parcel_content']
                                ; ?>
                                <h6 class="card-title">Shipment Type<br> <?php  echo $post[0]['shipment_type']
                                ; ?>
                                <h6 class="card-title">Departure Date <br> <?php  echo $post[0]['departure_date']
                                ; ?>
                                <h6 class="card-title">Expected Delivery Date <br> <?php  echo $post[0]['expected_delivery_date']
                                ; ?>
